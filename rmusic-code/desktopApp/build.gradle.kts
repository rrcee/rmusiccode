...
tasks.register("packageConveyorAppImage") {
    ...
    doLast {
        ...
        val iconDst = appDir.resolve("rmusic.png")
        ...
        val versionName =
            libs.versions.version.name
                .get()
        val desktopFile = appDir.resolve("rmusic.desktop")
        ...
        desktopFile.writeText(
            ...
            |Version=1.0
            |Name=r/music
            |Comment=r/music v${versionName} - FOSS YouTube Music Client
            |Exec=bin/rmusic %u
            |Icon=rmusic
            |Terminal=false
            |Categories=Audio;AudioVideo;
            |StartupWMClass=rmusic
        ...
        appRun.writeText(
            ...
            |if [ ! -f "${'$'}ICON_DIR/rmusic.png" ] || [ "${'$'}HERE/rmusic.png" -nt "${'$'}ICON_DIR/rmusic.png" ]; then
            |    mkdir -p "${'$'}ICON_DIR"
            |    cp "${'$'}HERE/rmusic.png" "${'$'}ICON_DIR/rmusic.png"
            ...
            |sed "s|Exec=bin/rmusic|Exec=${'$'}APPIMAGE_PATH|" "${'$'}HERE/rmusic.desktop" > "${'$'}DESKTOP_DIR/com-maxrave-simpmusic-MainKt.desktop"
        ...
        // Conveyor's launcher lives at output/bin/rmusic (lowercase).
        val appExecutable = appDir.resolve("bin/rmusic")
