...
actual fun LiquidGlassAppBottomNavigationBar(
    ...
    val constraintSet = remember(isShowMiniPlayer) {
        decoupledConstraints(isShowMiniPlayer)
    }

    // Permanently expanded bottom navigation bar in Apple Music style
    ...
    ConstraintLayout(
        ...
        MiniPlayer(
            Modifier
                .fillMaxWidth()
                // Spec: 8dp side margins, 64dp tall floating capsule.
