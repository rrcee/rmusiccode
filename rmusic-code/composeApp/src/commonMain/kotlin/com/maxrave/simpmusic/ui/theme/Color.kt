...
/**
 * Liked/favorite state (heart buttons, favorite tiles). Aligned to the brand red: Apple Music
 * renders liked hearts in the same system red as every other active control, and the old
 * hot-pink read as a second, competing accent next to it.
 */
val favoriteColor = seed
