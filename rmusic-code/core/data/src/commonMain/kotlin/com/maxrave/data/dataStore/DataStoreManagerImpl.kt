...
internal class DataStoreManagerImpl(
    ...
    override val reactToDeviceTilt: Flow<String>
        get() =
            settingsDataStore.data.map { preferences ->
                preferences[REACT_TO_DEVICE_TILT] ?: TRUE
            }
    ...
    override suspend fun setReactToDeviceTilt(enable: Boolean) {
        withContext(Dispatchers.Default) {
            if (enable) {
                ...
                settingsDataStore.edit { settings ->
                    settings[REACT_TO_DEVICE_TILT] = FALSE
                }
            }
        }
    }

    override val dumEMode: Flow<String>
        get() =
            settingsDataStore.data.map { preferences ->
                preferences[DUM_E_MODE] ?: FALSE
            }
    ...
    companion object Settings {
        ...
        val REACT_TO_DEVICE_TILT = stringPreferencesKey("react_to_device_tilt")
        val DUM_E_MODE = stringPreferencesKey("dum_e_mode")
