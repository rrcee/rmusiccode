...
interface DataStoreManager {
    ...
    val reactToDeviceTilt: Flow<String>

    suspend fun setReactToDeviceTilt(enable: Boolean)

    /**
     * Dum-E mode: a drastically simplified, oversized, all-glass shell for kids and older users.
     * Only Listen Again, Search, Downloads and Settings are reachable while it is on.
     */
    val dumEMode: Flow<String>

    suspend fun setDumEMode(enable: Boolean)
